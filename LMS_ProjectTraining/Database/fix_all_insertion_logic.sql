...
-- author_id lÀ Identity nÊn khÔng cẦn truyỀn vÀo
-- =============================================
...
-- publisher_id lÀ Identity nÊn khÔng cẦn truyỀn vÀo
-- =============================================
...
-- ĐẢm bẢo tẤt cẢ cÁc tham sỐ khỚp vỚi code C#
-- =============================================
...
PRINT N'=== ĐÃ CẬP NHẬT TẤT CẢ LOGIC THÊM (BOOKS, AUTHORS, PUBLISHERS) ===';
GO
