<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true" CodeBehind="AdminHome.aspx.cs" Inherits="LMS_ProjectTraining.Admin.AdminHome" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3><%= LMS_ProjectTraining.LanguageHelper.Get("welcome_admin") %></h3>
    <div class="container">
        <div class="row">
