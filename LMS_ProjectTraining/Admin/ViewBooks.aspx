                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 mb-4 border">
                            <div class="bg-white rounded shadow-sm">
                                ...
                                <div class="p-4">
                                    ...
                                    <%= LMS_ProjectTraining.LanguageHelper.Get("lbl_author_name_in") %>:<p class="small mb-0"><i class="fa fa-picture-o mr-2"></i><span class="font-weight-bold"><b><%# Eval("author_name") %></b></span></p>
